...
function ManagerLandingPage() {
  return (
    <div>
      ...
      <div id="learnmore" class="py-8 px-4 mx-auto container">
        <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
            <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-secondary-100 lg:h-12 lg:w-12 dark:bg-secondary-900">
              <svg
                class="w-5 h-5 text-secondary-600 lg:w-6 lg:h-6 dark:text-secondary-300"
                fill="currentColor"
                viewBox="0 0 20 20"
